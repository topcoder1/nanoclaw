...
- `send_message` — send a message to the user/group. Pass `email_id` + `email_account` when the message is about one specific email so the host attaches Expand / Full Email / Archive buttons.
